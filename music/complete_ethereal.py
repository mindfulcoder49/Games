...
# Extend the flute melody for variation
flute_melody_extension = [
...
flute_part.append(flute_melody_extension)  # Add the extension
...
# Add a counter-melody for strings
strings_counter_melody = [
...
strings_part.append(strings_counter_melody)

percussion_part = stream.Part()
percussion_part.insert(0, soft_percussion)
percussion_part.append(soft_percussion_part)

# Extend percussion part for dynamics
percussion_extension = [
    note.Rest(quarterLength=4),
    note.Note('F2', quarterLength=4),
    note.Rest(quarterLength=4),
    note.Note('F2', quarterLength=4),
]
percussion_part.append(percussion_extension)
...
score.write('midi', fp='ethereal_tranquil_song_complete.mid')

print("MIDI file 'ethereal_tranquil_song_complete.mid' has been created successfully!")
