...
# Define chord progressions for sections (I-V-vi-IV in C major)
chord_progressions = [
    ['C4', 'E4', 'G4'],  # C major (I)
    ['G4', 'B4', 'D5'],  # G major (V)
    ['A4', 'C5', 'E5'],  # A minor (vi)
...
def create_melody(scale, motif, length=8):
    ...
    for i in range(length):
        ...
        if random.random() > 0.7:
            melody_note.articulations.append(articulations.Staccato())  # Add some staccato
...
score.write('midi', fp='enhanced_pop_hit_song.mid')

print("MIDI file 'enhanced_pop_hit_song.mid' has been created successfully!")
